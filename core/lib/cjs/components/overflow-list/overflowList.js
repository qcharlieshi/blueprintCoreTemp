...
var OverflowList = /** @class */ (function (_super) {
    ...
    function OverflowList() {
        ...
        _this.callOnOverflow = function (prevState) {
            if (prevState.overflow.length === _this.state.overflow.length) {
                window.requestAnimationFrame(function () {
                    _this.props.onOverflow ? _this.props.onOverflow(_this.state.overflow) : null;
                });
            }
        };
        return _this;
