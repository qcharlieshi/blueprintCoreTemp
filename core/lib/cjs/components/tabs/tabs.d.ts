...
import { IOverflowListProps } from "..";
...
export declare class Tabs extends AbstractPureComponent<ITabsProps, ITabsState> {
    ...
    render(): JSX.Element;
    overflowRenderer: (items: React.ReactElement<ITabProps>[]) => JSX.Element;
    visibleItemRenderer: (item: React.ReactChild) => React.ReactChild;
    componentDidMount(): void;
    componentWillReceiveProps({selectedTabId, overflow}: ITabsProps): void;
     ...
     */
    private moveSelectionIndicator(onOverflow?);
